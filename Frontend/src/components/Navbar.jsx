...
function Navbar () {
  ...
  return (
    <>
    <div className={`max-w-screen-2xl navbar container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed left-0 right-0 top-0 z-50 ${
 ...
 <label className="swap swap-rotate">
  ...
  <div className="">
    <a className="bg-black text-white dark:bg-white dark:text-black dark:hover:bg-slate-200 px-4 py-2.5 rounded-md hover:bg-slate-700 duration-300 cursor-pointer font-bold" onClick={()=>document.getElementById("my_modal_3").showModal()}>Login</a>
    <Login />
  </div>
  </div>
</div>
